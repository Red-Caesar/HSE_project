...
public:
    ...
    /// and draw it using a m_sprite (for example).
...
/// \li creating a m_sprite from a 3D object rendered with OpenGL
/// \li etc.
///
/// Usage example:
///
...
///    texture.draw(m_sprite);  // m_sprite is a sf::Sprite
...
///
///    // Draw the texture
///    sf::Sprite m_sprite(texture.getTexture());
